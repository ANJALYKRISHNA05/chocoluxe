...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
    passport.use(new GoogleStrategy({
        ...
        callbackURL: `${process.env.BASE_URL || 'http://localhost:3003'}/user/auth/google/callback`,
    ...
    console.warn("Google OAuth environment variables (GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET) missing in .env - Google OAuth strategy disabled.");
}
